...
#ifndef PATCHTOOL_PATCHGEN_PATCHFILE_PATCHFILEFACTORY_H_
#define PATCHTOOL_PATCHGEN_PATCHFILE_PATCHFILEFACTORY_H_
...
#endif  // PATCHTOOL_PATCHGEN_PATCHFILE_PATCHFILEFACTORY_H_
